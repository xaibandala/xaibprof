...
"[project]/my-app/components/NeonScrollLine.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"use client";
;
function NeonScrollLine(param) {
    let { startRef, right = 24, anchorRef, side = "right", offset = 24, topOffset = 120, bottomOffset = 120, color = "#22d3ee", pinToFirstCard = true } = param;
    _s();
    const [progress, setProgress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [animatedProgress, setAnimatedProgress] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    const [leftPx, setLeftPx] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const easing = 0.06; // smaller = slower & smoother
    const dotSize = 8; // px
    const [dotOffsets, setDotOffsets] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]); // offsets from first dot (px)
    const [baseTop, setBaseTop] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(topOffset); // locked top after entering section
    const [locked, setLocked] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    // Page-space (document) Y of the locked first card center; stable across scroll
    const [lockedFirstCenterPageY, setLockedFirstCenterPageY] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [visibleFlags, setVisibleFlags] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NeonScrollLine.useEffect": ()=>{
            function clamp(n, min, max) {
                return Math.max(min, Math.min(max, n));
            }
            const onScroll = {
                "NeonScrollLine.useEffect.onScroll": ()=>{
                    ...
                    if (anchorRef === null || anchorRef === void 0 ? void 0 : anchorRef.current) {
                        ...
                        const centersPage = children.map({
                            "NeonScrollLine.useEffect.onScroll.centersPage": (el)=>{
                                const r = el.getBoundingClientRect();
                                return r.top + window.scrollY + r.height / 2; // page-space Y
                            }
                        }["NeonScrollLine.useEffect.onScroll.centersPage"]);
                    ...
                    const lastVisibleIdx = ({
                        "NeonScrollLine.useEffect.onScroll.lastVisibleIdx": ()=>{
                    ...
                    const maxH = dotsSpan || (("TURBOPACK compile-time truthy", 1) ? Math.max(80, Math.min(window.innerHeight - (topOffset + bottomOffset), Math.max(0, rect.height - (topOffset + bottomOffset)))) : "TURBOPACK unreachable");
                    ...
                    if (anchorRef === null || anchorRef === void 0 ? void 0 : anchorRef.current) {
                        ...
                        if (centersPage.length > 0) {
                            const basePage = lockedFirstCenterPageY !== null && lockedFirstCenterPageY !== void 0 ? lockedFirstCenterPageY : centersPage[0];
                            setDotOffsets(centersPage.map({
                                "NeonScrollLine.useEffect.onScroll": (c)=>Math.max(0, Math.round(c - basePage))
                            }["NeonScrollLine.useEffect.onScroll"]));
                        } else {
                            setDotOffsets([]);
                        }
                    ...
                    if (pinToFirstCard && (anchorRef === null || anchorRef === void 0 ? void 0 : anchorRef.current)) {
                        if (p > 0 && !locked) {
            ...
            const onResize = {
                "NeonScrollLine.useEffect.onResize": ()=>{
                    onScroll();
                    if ((anchorRef === null || anchorRef === void 0 ? void 0 : anchorRef.current) && side === "left") {
                    ...
                    if (anchorRef === null || anchorRef === void 0 ? void 0 : anchorRef.current) {
                        const children = Array.from(anchorRef.current.children);
                        const centersPage = children.map({
                            "NeonScrollLine.useEffect.onResize.centersPage": (el)=>{
                                const r = el.getBoundingClientRect();
                                return r.top + window.scrollY + r.height / 2; // page-space Y
                            }
                        }["NeonScrollLine.useEffect.onResize.centersPage"]);
                        if (centersPage.length > 0) {
                            const basePage = lockedFirstCenterPageY !== null && lockedFirstCenterPageY !== void 0 ? lockedFirstCenterPageY : centersPage[0];
                            const offsets = centersPage.map({
                                "NeonScrollLine.useEffect.onResize.offsets": (c)=>Math.max(0, Math.round(c - basePage))
                            }["NeonScrollLine.useEffect.onResize.offsets"]);
                            ...
                            setVisibleFlags({
                                "NeonScrollLine.useEffect.onResize": (prev)=>prev.length === centersPage.length ? prev : Array(centersPage.length).fill(false)
                            }["NeonScrollLine.useEffect.onResize"]);
                        } else {
                            setDotOffsets([]);
                            setVisibleFlags([]);
            ...
            if (anchorRef === null || anchorRef === void 0 ? void 0 : anchorRef.current) {
                ...
                observer = new IntersectionObserver({
                    "NeonScrollLine.useEffect": (entries)=>{
                        setVisibleFlags({
                            "NeonScrollLine.useEffect": (prev)=>{
                ...
                children.forEach({
                    "NeonScrollLine.useEffect": (el)=>observer.observe(el)
                }["NeonScrollLine.useEffect"]);
            }
            return ({
                "NeonScrollLine.useEffect": ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "NeonScrollLine.useEffect": ()=>{
            let raf = 0;
            const tick = {
                "NeonScrollLine.useEffect.tick": ()=>{
                    setAnimatedProgress({
                        "NeonScrollLine.useEffect.tick": (prev)=>{
            ...
            raf = requestAnimationFrame(tick);
            return ({
                "NeonScrollLine.useEffect": ()=>cancelAnimationFrame(raf)
            })["NeonScrollLine.useEffect"];
        }
    }["NeonScrollLine.useEffect"], [
        progress
    ...
    const sectionHeight = (()=>{
        ...
        return el ? Math.max(0, el.getBoundingClientRect().height - (topOffset + bottomOffset)) : 300;
    })();
    ...
    const fallbackMax = ("TURBOPACK compile-time truthy", 1) ? Math.max(80, Math.min(window.innerHeight - (topOffset + bottomOffset), sectionHeight)) : "TURBOPACK unreachable";
    ...
    const lineStyle = {
        ...
        height: 200,
        borderRadius: 999,
        background: "linear-gradient(180deg, ".concat(color, ", #a78bfa)"),
        boxShadow: "0 0 8px ".concat(color, ", 0 0 16px ").concat(color, ", 0 0 24px ").concat(color, "77"),
    ...
    const dotPosStyleBase = isLeft ? {
        left: (leftPx !== null && leftPx !== void 0 ? leftPx : 24) - (dotSize - 4) / 2
    } : {
            ...
            visible && dots.map((y, i)=>{
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    style: {
                        ...
                        boxShadow: active ? "0 0 6px ".concat(color, ", 0 0 14px ").concat(color, "AA") : "none",
                        zIndex: 41,
                        pointerEvents: "none",
                        ...dotPosStyleBase
                    }
...
_s(NeonScrollLine, "xULw7c2i8U2PWT+RIoY4S8tGRZQ=");
_c = NeonScrollLine;
var _c;
__turbopack_context__.k.register(_c, "NeonScrollLine");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$components$2f$NeonScrollLine$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/my-app/components/NeonScrollLine.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
function AboutPage() {
    ...
    const educationRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const eduListRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$components$2f$ClickSpark$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
            ...
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$my$2d$app$2f$components$2f$NeonScrollLine$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
...
_s(AboutPage, "0lsfcS+EaaaPl/xvKoqDltSNu44=", false, function() {
    return [
...
//# sourceMappingURL=my-app_d3277c65._.js.map